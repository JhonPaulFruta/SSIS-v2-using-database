...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.txtyear = ttk.Combobox(self, value=["BS STAT", "BS MATH", "BS IT", "BS CS","BSA","BS Bio","BS Chem","BSCE","BSHM","BS Micr","BSN","BA Hist","BAPhil","BA PoSc"], state="readonly", font=("Monaco", 12), textvariable=Course_Code, width=28)
